(function(){
  ...
  Moosipurk.prototype = {
    ...
    addNewClick: function(event){
      ...
      // tühja välja kontrollimine
      if (Object.getOwnPropertyNames(title).length > 0)
      return false;
        console.log("valjad ei ole tuhjad");
  ...
  //viisakalt kasutajale öelda, et toodet pole
  //1 väli juurde, kas special id, värv, kuupäev (näiteks, kas lisamise või säilivuse)
